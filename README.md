...
GPS情報があるすべての写真から検索して、撮影地が[周辺撮影地検索範囲](#周辺撮影地検索範囲)内にある写真を、[周辺撮影地検索上限](#周辺撮影地検索上限)まで近い順に表示します。
...
[画像一覧のコンテクストメニュー](#画像一覧のコンテクストメニュー)で[撮影地周辺の写真を検索](#撮影地周辺の写真を検索)する際の、検索範囲を指定します。

### 周辺撮影地検索上限

[画像一覧のコンテクストメニュー](#画像一覧のコンテクストメニュー)で[撮影地周辺の写真を検索](#撮影地周辺の写真を検索)する際の、表示する検索結果の数の上限を指定します。
